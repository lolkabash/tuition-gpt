...
prompt = "here is a list of learning objectives{}, you will iterate through the list and simplify the sentence into its core idea, and provide key words that i can search for in youtube. you will then stricly output a python list containing those key words do not add courtesy messages".format(list_a)
